...
class ContractsService {
   ...
   */
  async transferLedger(payload: { from_contract_id: number; to_contract_id: number; amount: number; description?: string; idempotency_key?: string }): Promise<{ transfer_id: string; from_balance: string; to_balance: string }> {
