...
class DashboardService {
  ...
  async getLayouts(): Promise<DashboardLayout[]> {
    try {
      const response = await this.auth.apiClient.get("/api/dashboard/layouts");
      return response.data.data;
    } catch (error) {
  ...
  async deleteLayout(layoutId: string): Promise<void> {
    try {
      await this.auth.apiClient.delete(`/api/dashboard/layouts/${layoutId}`);
    } catch (error) {
